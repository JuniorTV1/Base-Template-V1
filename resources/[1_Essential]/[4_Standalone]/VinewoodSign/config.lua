...
Config.AuthorizedGroups = {
    ...
    identifier = {  -- Ajoute ici les identifiants discord qui ont le droit de modifier les paneau exemple : [ 'discord:..........' ] tips: si plusieurs oublier pas de mettre une "," !
        'discord:1119615831710642197'
    }
}
