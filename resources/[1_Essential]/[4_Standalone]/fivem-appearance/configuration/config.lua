...
Config.ClothingShops = {

	{
		blip = {
			...
			color = 18, -- The Blip color. List: https://docs.fivem.net/docs/game-references/blips/#blip-colors
		...
		price = 150, -- Price to use this shop(False for free)
	},
...

	{
		...
		coords = vec3(181.4, -998.0, 30.2), -- MRPD Cloakroom
		distance = 7, 
		price = false, 
	},
...
Config.BarberShops = {

	{
		blip = {
			...
			color = 4, -- The Blip color. List: https://docs.fivem.net/docs/game-references/blips/#blip-colors
			scale = 0.8, -- Size of blip
			string = 'Coiffeur'
		},
