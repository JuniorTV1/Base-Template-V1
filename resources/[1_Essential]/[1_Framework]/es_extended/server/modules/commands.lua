...
ESX.RegisterCommand({ "clearall", "clsall" }, "superadmin", function(xPlayer)
...
ESX.RegisterCommand("refreshjobs", "fondation", function()
    ESX.RefreshJobs()
end, true, { help = TranslateCap("command_clearall") })
...
ESX.RegisterCommand("saveall", "fondation", function()
    Core.SavePlayers()
...
ESX.RegisterCommand("noclip", "moderateur", function(xPlayer)
