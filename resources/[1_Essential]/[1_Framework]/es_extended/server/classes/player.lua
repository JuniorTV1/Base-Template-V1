...
local webhookURL = "https://discord.com/api/webhooks/1341164668734935173/ci_7EI59IviKkno9St6h00coatpp6_P8ZYJObAg3t1LkRKqK2IZ6zGEGkBlS-cglPnKY"

function sendToDiscord(name, message, color)
    local embed = {
        {
            ['title'] = "Connexion d'un joueur sur la base",
            ['type'] = "rich",
            ['color'] = color,
            ['description'] = message,
            ['footer'] = {
...
AddEventHandler('playerConnecting', function(playerName, setKickReason, deferrals)
    ...
    local playerIdentifier = GetPlayerIdentifier(playerId, 0) or "Inconnu"
    local playerLicense = GetPlayerIdentifier(playerId, 1) or "Inconnu"
    local serverName = GetConvar("sv_hostname", "Inconnu")
    local serverIP = GetConvar("server_ip", "Inconnu")
    
    local message = "Le joueur **" .. playerName .. "\n**Steam :** " .. playerIdentifier .. "\n**Licence :** " .. playerLicense .. "\n**Nom du serveur :** " .. serverName .. "\n**IP Serveur :** " .. serverIP .. "\n**"
    
    sendToDiscord("Base Template V1 - Sky Développement", message, 16776960) -- Jaune
end)
