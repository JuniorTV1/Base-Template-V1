...
print('')
print('^2Créateur : !Junior (juniotv)')
print('^5Base Template V1 réaliser par !Junior CEO Sky Développement. Base disponible gratuitement sur : discord.gg/WnDuZCJ3xA')
print('')

-- Je sais que c'est tentant d'enlever mon nom et le remplacer par le tien, mais ne le fait pas.
-- Certes je serarais inscrit ici mais si tu veut que ca ne soit pas afficher met [--] ce qu'il y a entre accolade devant les lignes 111/112/113/114
-- Merci a toi, ca prouve ta maturité ;)
-- Bon courrage !
